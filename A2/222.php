...
<body>
    ...
    <div class="side-bar">
        <div class="header">
            <a href="index.html" class="logo">ONE FOR ALL </a>
...
while(!feof($myfile)){
	...
	echo  $array[0]."  ".$array[1]."<br/><form action='moreinfo.php' method='POST'><input style='display:none;'type='text' value=".$platenum." name='platenum'><input type='submit' value='more info' name='submit'><br/>";
